class Badge < ActiveRecord::Base
  ...
  RULES_PARAMS = %w(qtty period_qtty period_type period_variant predicate_types)
  
  RULES_PARAMS.each do |par|
    
    self.class_eval do
      
      define_method :"#{par}" do
        params[par] || read_attribute(par.to_sym) 
      end
